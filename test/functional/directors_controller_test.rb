...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { date_of_birth: @director.date_of_birth, gender: @director.gender, name: @director.name }
    end
  ...
  test "should update director" do
    put :update, id: @director, director: { date_of_birth: @director.date_of_birth, gender: @director.gender, name: @director.name }
    assert_redirected_to director_path(assigns(:director))
  end
