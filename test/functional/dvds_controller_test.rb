...
class DvdsControllerTest < ActionController::TestCase
  ...
  test "should create dvd" do
    assert_difference('Dvd.count') do
      post :create, dvd: { amazon_id: @dvd.amazon_id, name: @dvd.name, release_date: @dvd.release_date, summary: @dvd.summary }
    end
  ...
  test "should update dvd" do
    put :update, id: @dvd, dvd: { amazon_id: @dvd.amazon_id, name: @dvd.name, release_date: @dvd.release_date, summary: @dvd.summary }
    assert_redirected_to dvd_path(assigns(:dvd))
  end
