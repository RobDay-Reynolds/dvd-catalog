...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { date_of_birth: @actor.date_of_birth, gender: @actor.gender, name: @actor.name }
    end
  ...
  test "should update actor" do
    put :update, id: @actor, actor: { date_of_birth: @actor.date_of_birth, gender: @actor.gender, name: @actor.name }
    assert_redirected_to actor_path(assigns(:actor))
  end
